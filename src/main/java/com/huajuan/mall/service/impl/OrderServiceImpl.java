...
import com.huajuan.mall.dao.OrderItemMapper;
import com.huajuan.mall.dao.OrderMapper;
import com.huajuan.mall.dao.ProductMapper;
import com.huajuan.mall.dao.ShippingMapper;
import com.huajuan.mall.enums.OrderStatusEnum;
import com.huajuan.mall.enums.PaymentTypeEnum;
import com.huajuan.mall.enums.ProductStatusEnum;
import com.huajuan.mall.enums.ResponseEnum;
import com.huajuan.mall.pojo.Order;
import com.huajuan.mall.pojo.OrderItem;
import com.huajuan.mall.pojo.Product;
import com.huajuan.mall.pojo.Shipping;
import com.huajuan.mall.service.ICartService;
import com.huajuan.mall.service.IOrderService;
import com.huajuan.mall.vo.Cart;
import com.huajuan.mall.vo.OrderItemVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ResponseVo<OrderVo> create(Integer uid, Integer shippingId) {
        ...
        if (CollectionUtils.isEmpty(cartList)) {
            return ResponseVo.error(ResponseEnum.CART_sELECTED_ISEMPTY);
        }
        ...
        //计算价格, 只计算被选中商品
        //生成订单, 入库: order和order_item, 事务. 两个表一致
    ...
    public void paid(Long orderNo) {
        ...
        int row = orderMapper.updateByPrimaryKeySelective(order);
        if (row <= 0) {
            throw new RuntimeException("订单更新为已支付状态失败，订单id: " + orderNo);
        }
