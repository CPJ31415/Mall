...
public class ShippingServiceImplTest extends MallApplicationTests {
    ...
    public void before() {
        ...
        form.setReceiverName("CPJ");
        form.setReceiverAddress("SCUT");
        form.setReceiverCity("GZ");
        form.setReceiverMobile("18717100603");
        form.setReceiverPhone("010123456");
        form.setReceiverProvince("GZ");
        form.setReceiverDistrict("PY");
